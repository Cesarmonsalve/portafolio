        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="animate-slide-left">
            ...
            <a href={`mailto:${cfg.contact_email}`}
              className="group flex items-center gap-4 p-5 rounded-2xl bg-white/[0.02] border border-white/[0.06] hover:border-neon-red/30 hover:bg-neon-red/[0.04] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 mb-8">
                  ...
                  {enabledSocials.map((social, i) => {
                    ...
                    return (
                      <a key={social.id} href={social.url} target="_blank" rel="noopener noreferrer"
                        className="flex items-center gap-3 p-3.5 rounded-xl bg-white/[0.02] border border-white/[0.05] hover:border-white/[0.12] hover:scale-[1.03] hover:-translate-y-0.5 transition-all duration-300 group cursor-pointer opacity-0 animate-slide-up"
          ...
          <div className="animate-slide-right" style={{ animationDelay: '0.15s' }}>
            <form onSubmit={handleSubmit} className="relative">
              {sent && (
                <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-bg/95 backdrop-blur-xl rounded-2xl border border-green-500/20 animate-fade-in">
              ...
              {error && (
                <div className="mb-4 flex items-center gap-3 p-4 rounded-xl bg-red-500/10 border border-red-500/20 animate-fade-in">
              ...
              <div className="space-y-4">
                ...
                <button type="submit" disabled={sending}
                  className="group relative w-full overflow-hidden flex items-center justify-center gap-3 bg-neon-red px-8 py-4 rounded-xl font-bold text-[12px] tracking-[0.15em] text-white transition-all hover:shadow-[0_0_40px_rgba(255,0,51,0.35)] hover:scale-[1.02] active:scale-[0.98] disabled:opacity-60">
